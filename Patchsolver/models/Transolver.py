...
class Model(nn.Module):
    ...
    def forward(self, data):
        ...
        # print(f'cfd_data: {cfd_data}') # DataBatch(x=[401176, 7], y=[401176, 3], batch=[401176], ptr=[2])
        # print(f'cfd_data.x.shape: {cfd_data.x.shape}') # torch.Size([401176, 7])
        # print(f'cfd_data.y.shape: {cfd_data.y.shape}') # torch.Size([401176, 3])
        # print(f'cfd_data.pos.shape: {cfd_data.pos.shape}')
        # print(f'cfd_data.surf.shape: {cfd_data.surf.shape}')
        # print(f'cfd_data.edge_index.shape: {cfd_data.edge_index.shape}')
